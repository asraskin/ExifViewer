...
AlanSRaskin.ExifViewer.Makers.dumpGenericTagData = function (ifd, output, is_motorola) {
	var tagnum;
	for (var t in ifd) {
...
AlanSRaskin.ExifViewer.Makers.getGenericInterpretedTagData = function (tagnum, data) {
	var output = [];
	switch (tagnum) {
	default:
